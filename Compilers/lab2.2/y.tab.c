...
/* This calculator depends on a LEX description which outputs either VARIABLE or INTEGER.
   ...
   Shaun Cooper
	...
	4) The algorithm used was just simple counting of the newlines.
		...
		b) the output is the correct calculated value
		c) the assumption is that all the input wil be alphanumeric
	
	Changes to Code: 
		the multiplication rule was added
		in the unary minus rule I removed the first expr since it only needs to look for "-" expr
